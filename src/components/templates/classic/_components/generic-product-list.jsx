...
const GenericProductList = ({ viewMode, searchQuery = "", storeId, categoryId, limit = 20, }) => {
    ...
    if (error) {
        return (<div className="text-center font-bold text-2xl text-destructive">
    ...
    return (<section>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {filteredProducts.map((product) => {
            ...
            return (<ProductCard key={product.id} product={product} isInitiallySaved={isSaved}/>);
        })}
      </div>
      {/* Pagination */}
