...
export function ProductWheel({ storeId, circleTime = 3, productCount = 6, categoryId = "all", }) {
    ...
    if (isLoading) {
        ...
        <CarouselContent>
          {Array.from({ length: productCount }).map((_, index) => (<CarouselItem key={index} className="basis-1/2 md:basis-1/3 lg:basis-1/5">
              <div className="p-1">
            ...
            <div className="p-1">
              <Card className="cursor-pointer hover:shadow-lg transition-all aspect-[1/1] bg-cover duration-300 relative" style={{
                ...
                handleWishlistClick(product.id);
                    ...
                    <Heart className={`h-4 w-4 ${savedStatus[product.id]
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="flex items-center justify-between mb-1 md:mb-4">
                      <div className="flex flex-col items-start space-x-2">
                        ...
                        {product.slashedFrom && (<span className="text-xs md:text-sm text-gray-300 line-through">
                ...
                <CardFooter className="px-4" onClick={(e) => {
                e.preventDefault();
                e.stopPropagation();
            }}>
