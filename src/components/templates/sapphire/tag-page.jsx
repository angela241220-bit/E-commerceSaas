...
export default function TagsPage({ store, tag, }) {
    ...
    return (<section className="min-h-screen flex flex-col dark:bg-[#1e1b4b] dark:text-white bg-white pt-10">
      ...
      <div className="container mx-auto flex-1 mt-16 px-4">
        ...
        {isLoading ? (<div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            {products && products.length > 0 ? (<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
