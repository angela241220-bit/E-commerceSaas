    ...
    return (<Card className="cursor-pointer hover:shadow-lg transition-all aspect-[1/1] bg-cover hover:scale-105 duration-300" style={{
      ...
      <Link href={`/products/${product.slug}`} className="p-6 pb-1 flex flex-col h-full">
        <div className="relative mb-4">
          <Button size="sm" variant="outline" className="absolute top-2 right-2 w-8 h-8 p-0 rounded-full" onClick={(e) => {
            e.preventDefault();
            e.stopPropagation();
            handleWishlist();
        ...
        <div className="mt-auto">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex flex-col items-start space-x-2">
              ...
              {product.slashedFrom && (<span className="text-sm text-gray-300 line-through">
