...
const FooterSkeleton = () => {
    return (<footer className="bg-gradient-to-r from-blue-900 via-purple-800 to-purple-900 text-white border-t mt-8">
...
export const Footer = ({ storeSlug }) => {
    ...
    if (isError || !store) {
        return (<footer className="bg-sidebar border-t mt-8">
      ...
      <div className="container max-w-5xl mx-auto px-2 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              {store.socials.map((social) => (<a href={social.link} className="hover:text-primary" target="_blank" rel="noopener noreferrer" key={social.name}>
