...
const SearchPageSkeleton = () => (<section className="flex flex-col min-h-screen">
...
const SearchPageComponent = ({ store, }) => {
    return (<section className="flex flex-col min-h-screen mt-16 dark:bg-[#1e1b4b] dark:text-white bg-white">
