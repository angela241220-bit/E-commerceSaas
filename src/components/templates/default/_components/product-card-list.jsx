...
const ProductCardList = ({ product, isInitiallySaved = false, }) => {
    ...
    return (<div className="overflow-hidden border-none shadow-sm hover:shadow-md transition-all duration-300 bg-card rounded-md">
      <div className="flex flex-col sm:flex-row">
        ...
        <div className="flex-1 p-4 flex flex-col">
          <div className="flex justify-between items-start mb-2">
            ...
            <Button variant="ghost" size="icon" className="h-8 w-8" onClick={handleWishlist} disabled={isWishlistLoading}>
          ...
          <div className="mt-auto">
            <div className="flex items-baseline gap-2 mb-4">
              ...
              {product.slashedFrom && (<span className="text-sm text-muted-foreground line-through">
                  {formatPrice(product.slashedFrom, "en-NG", "NGN")}
                </span>)}
            </div>

            <div className="flex items-center gap-4">
              {!cartItem ? (<Button className="gap-1" onClick={handleAddToCart} disabled={product.trackQuantity && product.inStock <= 0}>
                ...
                : "Add to Cart"}
                  ...
                  <Button variant="outline" size="icon" onClick={handleIncrement} disabled={product.trackQuantity &&
