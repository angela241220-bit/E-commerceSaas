    ...
    return (<div>
      <section className="container max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {[...Array(4)].map((_, index) => (<div key={index} className="group">
...
const ByCategories = ({ storeId }) => {
    ...
    return (<div>
      <div className="container max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {categories.map((category) => (<Link key={category.slug} href={`/categories/${category.slug}`} className="group">
              <div className="relative rounded-lg overflow-hidden">
                <div className="aspect-square">
                  <Image width={300} height={300} src={category.imageUrl || "/placeholder.svg"} alt={category.name} className="object-cover w-full h-full transition-transform duration-500 group-hover:scale-105"/>
                </div>
