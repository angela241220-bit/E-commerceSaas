...
export default async function StoreAnalytics({ storeSlug, days = 7, }) {
    try {
        // Get store ID
        ...
        const recentVisits = await db
            .select()
            .from(storeVisit)
            .where(and(eq(storeVisit.storeId, storeRecord[0].id), gte(storeVisit.createdAt, dateFrom)))
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="space-y-2">
              {deviceStats.map((stat) => (<div key={stat.device} className="flex justify-between items-center p-2 bg-gray-50 rounded">
          ...
          <div>
            ...
            <div className="space-y-2">
              {browserStats.map((stat) => (<div key={stat.browser} className="flex justify-between items-center p-2 bg-gray-50 rounded">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full bg-white border border-gray-200">
              ...
              <tbody className="divide-y divide-gray-200">
                {recentVisits.slice(0, 10).map((visit) => (<tr key={visit.id}>
