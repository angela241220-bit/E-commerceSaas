...
export const StoreSchema = z.object({
    name: z
        .string()
        .min(3, {
        message: "Store Name should be more than 3 characters but less than 50 characters",
    })
        .max(50, {
        message: "Store Name should be more than 3 characters but less than 50 characters",
    })
    ...
    address: z
        ...
        .regex(/^[a-zA-Z0-9\s-.,]+$/, {
        message: "Address can only contain letters, numbers, spaces, hyphens, commas, and periods.",
    }),
});
export const NewProductSchema = z
    ...
    name: z
        ...
        .regex(/^[a-zA-Z0-9\s-.,]+$/, {
        message: "Product Name can only contain letters, numbers, spaces, hyphens, commas, and periods.",
    }),
    description: z
        .string()
        ...
        .regex(/^[a-zA-Z0-9\s-.,!?"]+$/, {
        message: "Description can only contain letters, numbers, spaces, hyphens, commas, periods, exclamation marks, question marks, and quotation marks.",
    }),
...
export const CreateCategorySchema = z.object({
    name: z
        .string()
        .min(3, {
        message: "Category Name should be more than 3 characters but less than 50 characters",
    })
        .max(50, {
        message: "Category Name should be more than 3 characters but less than 50 characters",
    })
...
export const CreateTagSchema = z.object({
    name: z
        .string()
        .min(2, {
        message: "Tag Name should be more than 2 characters but less than 30 characters",
    })
        .max(30, {
        message: "Tag Name should be more than 2 characters but less than 30 characters",
    })
