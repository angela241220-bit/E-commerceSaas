...
import db from "@/db";
import { category, user, product, productImage, productSource, tag, productTag, } from "@/db/schema";
import { slugify } from "@/lib/utils";
import { eq, and, ne } from "drizzle-orm";
import { serverAuth } from "@/lib/server-auth";
const MAX_FILES = 5;
export const updateProduct = async (productId, values, merchantId, storeId) => {
    try {
        ...
        if (allTagIds.length > 0) {
            ...
            updatedProduct.tags = insertedProductTags;
        }
