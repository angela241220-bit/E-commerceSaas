...
import { category, user, product, productImage, productSource, productVariant, tag, productTag, } from "@/db/schema";
...
const MAX_FILES = 5;
export const createProduct = async ({ values, merchantId, storeId, categoryImageUrl, }) => {
    try {
        ...
        const limitCheck = await FeatureLimitService.canUseFeature(merchantId, "products_count", 1);
        ...
        if (allTagIds.length > 0) {
            ...
            newProduct.tags = insertedProductTags;
        }
