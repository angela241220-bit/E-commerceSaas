...
export async function updateOrderStatus(params) {
    ...
    try {
        ...
        if (paymentStatus) {
            ...
            if (!validPaymentTransitions[existingOrder.paymentStatus]?.includes(paymentStatus)) {
        ...
        if (fulfillmentStatus) {
            ...
            if (!validFulfillmentTransitions[existingOrder.fulfillmentStatus]?.includes(fulfillmentStatus)) {
 ...
 */
export async function updatePaymentStatus(orderId, storeId, paymentStatus) {
 ...
 */
export async function updateFulfillmentStatus(orderId, storeId, fulfillmentStatus) {
    return updateOrderStatus({
        orderId,
        storeId,
        fulfillmentStatus
