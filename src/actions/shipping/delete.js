...
export const deleteShippingZone = async (shippingZoneId, storeSlug, merchantId) => {
    try {
        ...
        await db
            .delete(shippingZone)
            .where(and(eq(shippingZone.id, shippingZoneId), eq(shippingZone.storeId, storeData.id)));
