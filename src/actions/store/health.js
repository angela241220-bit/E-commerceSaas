...
const getRecommendations = (health, slug) => {
...
export const getStoreHealth = async (storeId, storeSlug) => {
    const [bankDetails, productCountResult, shippingZoneDetails, storeDetails] = await Promise.all([
