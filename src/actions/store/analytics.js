...
export async function trackStoreVisit(visitorData) {
    try {
        ...
        const { device, browser, os } = parseUserAgent(visitorData.userAgent || null);
...
export async function getStoreAnalytics(storeSlug, days = 30) {
