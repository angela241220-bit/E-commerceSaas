...
import db from "@/db";
import { customerSavedProduct, product, productImage, category, } from "@/db/schema";
...
export const saveProduct = async (productId) => {
    ...
    try {
        ...
        const existingSave = await db
            ...
            .where(and(eq(customerSavedProduct.customerId, customer.id), eq(customerSavedProduct.productId, productId)))
            .limit(1);
