...
const LOGO_URL = info.logoUrl || "https://via.placeholder.com/150x50?text=YourLogo";
const LOGO_ALT = `${info.name} Logo`;
/**
 * Base Email Template Generator
 */
function getBaseEmailTemplate(title, preheader, contentHtml) {
...
class MailService {
    ...
    getPasswordResetTemplate(resetUrl) {
        ...
        <p>Hi there,</p>
        <p>We received a request to reset the password for your ${info.name} account. You can do this by clicking the button below.</p>
    ...
    getVerificationEmailTemplate(verificationUrl) {
        ...
        const contentHtml = `
        <h1 style="margin: 0 0 20px 0; font-size: 24px; line-height: 1.3; color: #333333; font-weight: normal;">Welcome to ${info.name}!</h1>
        <p>Hi there,</p>
        ...
        <p>Once verified, you can start exploring all that ${info.name} has to offer.</p>
        <hr style="border: 0; border-top: 1px solid #eaeaea; margin: 30px 0;">
        <p style="font-size: 13px; color: #888888;">If the button doesn't work, copy and paste this link into your browser:</p>
