...
import { Settings, Users, ShieldCheck, Crown, Database, Activity, BarChart3, Lock, } from "lucide-react";
    ...
    return (<div className="container mx-auto p-6 space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {adminSections.map((section) => {
            ...
            return (<Link key={section.href} href={section.href}>
              <Card className={`transition-all hover:shadow-lg cursor-pointer ${section.borderColor} ${section.bgColor}`}>
