...
const ProductVariants = ({ colors = [], sizes = [], value, onChange, trackQuantity, basePrice, onAddColor, onAddSize, storeProfileId, storeId, }) => {
    ...
    return (<div className="space-y-6">
      <div className="space-y-4">
              ...
              <Dialog open={isAddingColor} onOpenChange={setIsAddingColor}>
                ...
                <DialogContent>
                  ...
                  <div className="space-y-4">
                    ...
                    <Button onClick={handleAddColor} className="w-full" type="button">
                      Add Color
                    </Button>
                  </div>
                </DialogContent>
              ...
              <Dialog open={isAddingSize} onOpenChange={setIsAddingSize}>
                ...
                <DialogContent>
                  ...
                  <div className="space-y-4">
                    ...
                    <Button onClick={handleAddSize} className="w-full" type="button">
                      Add Size
                    </Button>
                  </div>
                </DialogContent>
        ...
        <div className="flex gap-2 flex-wrap">
          {selectedColors.map((colorId) => (<div key={colorId} className="flex items-center gap-1 bg-gray-100 px-2 py-1 rounded">
          ...
          {selectedSizes.map((sizeId) => (<div key={sizeId} className="flex items-center gap-1 bg-gray-100 px-2 py-1 rounded">
