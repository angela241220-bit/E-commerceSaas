...
const CategoryInfo = ({ category, storeSlug }) => {
    ...
    return (<div className="container mx-auto px-4 py-8">
      <GenericProductList storeId={category.storeId} storeSlug={storeSlug} products={products} header={<h1 className="text-4xl font-bold mb-4">{category.name}</h1>} productDetailsPath={(product) => `/merchant/stores/${storeSlug}/products/${product.slug}`}/>
