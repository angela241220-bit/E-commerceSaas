...
const Visitors = ({ storeId, days }) => {
    ...
    return (<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="bg-background p-2 md:p-6 rounded-lg shadow-sm border">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={analyticsData.dailyVisitors}>
            ...
            <YAxis />
            <Tooltip labelFormatter={(date) => new Date(date).toLocaleDateString("en-US", {
            weekday: "long",
            month: "long",
            day: "numeric",
      ...
      <div className="bg-background p-6 rounded-lg shadow-sm border">
        ...
        {analyticsData.osBreakdown.length === 0 ? (<p className="text-muted-foreground text-center">
            No OS data available for this period
          </p>) : (<div className="space-y-4">
            {analyticsData.osBreakdown.slice(0, 5).map((osData, index) => (<div key={osData.os} className="flex items-center justify-between">
                <div className="flex items-center">
            ...
            {analyticsData.totalVisits > 0 && (<div className="mt-4 pt-4 border-t">
