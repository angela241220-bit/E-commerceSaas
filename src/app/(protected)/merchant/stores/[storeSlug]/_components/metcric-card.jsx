...
export const MetricCard = ({ title, value, change, icon: Icon, format = "number", period = "last period", }) => {
    ...
    return (<div className="bg-background p-3 md:p-6 rounded-lg shadow-sm border">
