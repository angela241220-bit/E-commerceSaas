...
const TagInfo = ({ tag, storeSlug }) => {
    ...
    return (<div className="container mx-auto px-4 py-8">
      <GenericProductList storeId={tag.storeId} storeSlug={storeSlug} products={products} header={<div className="mb-6">
          ...
          </div>} productDetailsPath={(product) => `/merchant/stores/${storeSlug}/products/${product.slug}`}/>
