...
const page = async ({ params, }) => {
    ...
    if (!merchant?.user)
        return redirect(`/auth/sign-in?callbackURL=/merchant/stores/${storeSlug}/tags/${tagSlug}/edit`);
    ...
    if (!tagData)
        return redirect(`/merchant/stores/${storeSlug}/tags`);
    return (<EditTagForm storeId={storeData[0].id} merchantId={merchant.user.id} storeSlug={storeSlug} tag={tagData}/>);
};
export default page;
