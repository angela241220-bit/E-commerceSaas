...
const page = async ({ params }) => {
    ...
    if (!session?.session || !session.user) {
        return redirect(`/sign-in?callbackURL=/merchant/stores/${storeSlug}/banners`);
    }
    ...
    if (banners.length === 0) {
        return (<div className="container mx-auto p-4 flex flex-col items-center justify-center mt-28 gap-4">
