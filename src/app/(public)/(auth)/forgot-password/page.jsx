...
export const metadata = {
    ...
    description: "Reset your Supple Store account password securely.",
};
const page = async () => {
    ...
    return (<div className="grid min-h-screen lg:grid-cols-2 bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 font-sans">
      ...
      <div className="relative hidden lg:block border-l border-zinc-200 dark:border-zinc-800 bg-zinc-950 overflow-hidden">
        <Image src="/images/shoper-af5Oi0kOByE-unsplash.jpg" alt="Shopping" fill className="absolute inset-0 h-full w-full object-cover mix-blend-overlay opacity-30 dark:opacity-40 grayscale" priority/>
